...
function getSidebarLinkClasses({ isActive }) {
  if (isActive) {
    return 'block rounded-lg bg-slate-900 px-3 py-2 text-sm font-medium text-white shadow-sm'
  }

  return 'block rounded-lg px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100 transition-colors'
}
