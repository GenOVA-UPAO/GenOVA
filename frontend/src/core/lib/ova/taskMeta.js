...
export const TASK_META = {
  ...
  imagen: {
    label: 'Imagen', desc: 'Recursos visuales del OVA', Icon: Image,
    grad: 'from-pink-500/[.07] to-pink-500/[.02]',
    accent: 'text-pink-600', iconBg: 'bg-pink-500/10 border-pink-500/20',
    badge: 'bg-pink-500/10 text-pink-600 border-pink-500/25',
    chip: 'bg-pink-500/8 text-pink-600 border-pink-500/20', num: 'text-pink-600 font-black',
  },
  video: {
    label: 'Video', desc: 'Clips multimedia', Icon: FilmReel,
    grad: 'from-teal-500/[.07] to-teal-500/[.02]',
    accent: 'text-teal-600', iconBg: 'bg-teal-500/10 border-teal-500/20',
    badge: 'bg-teal-500/10 text-teal-600 border-teal-500/25',
    chip: 'bg-teal-500/8 text-teal-600 border-teal-500/20', num: 'text-teal-600 font-black',
  },
}
