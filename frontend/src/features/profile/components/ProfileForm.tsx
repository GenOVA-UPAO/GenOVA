...
import { profileSchema } from '@/features/profile/schemas/user'
...
export function ProfileForm({
  ...
  const {
    ...
    defaultValues: { ...profile, gender: profile.gender ?? '' },
  })
        ...
        {!hideHeader && (
          <div className="flex flex-col sm:flex-row items-center gap-6 pb-6 border-b border-border/50">
            ...
            <div className="text-center sm:text-left space-y-1">
              <h2 className="text-lg font-bold capitalize font-display">
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[10px] text-muted-foreground">
              Se autocompletará con ceros a la izquierda a 9 dígitos al
              guardarse.
            </p>
          </div>
