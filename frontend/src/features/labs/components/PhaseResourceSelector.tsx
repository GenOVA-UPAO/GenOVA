...
interface ResourceGridProps {
  ...
  onSelect: (phase: string, type: number) => void
}

interface PhaseResourceSelectorProps {
  selectedPhase: string | null
  selectedType: number | null
  onSelect: (phase: string, type: number) => void
}
...
const EXPLORE_RESOURCES: Resource[] = [
...
export function PhaseResourceSelector({
  selectedPhase,
  selectedType,
  onSelect,
}: PhaseResourceSelectorProps) {
  return (
