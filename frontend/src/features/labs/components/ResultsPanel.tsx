...
import { ResultCard } from '@/features/labs/components/ResultCard'
...
export function ResultsPanel({
  ...
  return (
    <div className="flex flex-col gap-4">
      <div
        className={`grid gap-4 ${count === 1 ? 'grid-cols-1' : 'grid-cols-2'}`}
      >
        {slots.map((r, i) => (
          <ResultCard
            ...
            <div className="mt-4 space-y-3">
              ...
              {improvedPrompt.improved_prompt ? (
                <div>
                  ...
                  <Button size="sm" onClick={onApplyImproved} className="mt-2">
                    Aplicar al editor
                  </Button>
                </div>
              ) : null}
