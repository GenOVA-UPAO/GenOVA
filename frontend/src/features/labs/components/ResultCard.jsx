        ...
        {isError ? (
          <div className="flex min-h-[300px] items-center justify-center bg-destructive/5 p-4">
            <div className="text-center">
              <p className="text-sm font-medium text-destructive">Error al generar</p>
              <p className="mt-1 text-xs text-destructive/70 max-w-xs break-words">{result.error}</p>
            </div>
          </div>
          ...
          <div className="flex h-[360px] items-center justify-center bg-muted/20">
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-xs text-muted-foreground">Generando recurso...</p>
            </div>
          </div>
        )}
      </div>
