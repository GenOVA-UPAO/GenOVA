...
import { ModelSelector } from '@/features/labs/components/ModelSelector'
import { PhaseResourceSelector } from '@/features/labs/components/PhaseResourceSelector'
import { PromptEditor } from '@/features/labs/components/PromptEditor'
import { ResultsPanel } from '@/features/labs/components/ResultsPanel'
import { useLabGeneration } from '@/features/labs/hooks/useLabGeneration'
      ...
      <div className="flex flex-col gap-1.5 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Prueba y mejora los prompts de generación de recursos, compara
            modelos de IA y optimiza resultados en tiempo real.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-background p-5 shadow-sm space-y-4">
        <div className="border-b border-border pb-3">
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Elige la fase y el tipo de recurso didáctico para comenzar a
            experimentar.
          </p>
        </div>
      ...
      {lab.selectedPhase ? (
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-start">
            <div className="lg:col-span-1 rounded-xl border border-border bg-background p-5 shadow-sm space-y-4">
              <div className="border-b border-border pb-3">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Define los parámetros y los modelos a contrastar.
                </p>
              </div>
            ...
            <div className="lg:col-span-2 rounded-xl border border-border bg-background p-5 shadow-sm">
              <div className="border-b border-border pb-3 mb-4">
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Modifica las instrucciones del agente para esta prueba.
                </p>
              </div>
              <PromptEditor
          ...
          <div className="space-y-4">
            <div className="border-b border-border pb-2">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Compara los recursos generados y exporta la versión óptima.
              </p>
            </div>
            <ResultsPanel
              results={lab.results}
        ...
        <div className="rounded-xl border border-border bg-background p-8 shadow-sm flex flex-col items-center justify-center min-h-[300px] text-center">
          ...
          <h3 className="mt-4 text-base font-bold">
            Sandbox de Iteración de Prompts
          </h3>
          <p className="mt-2 text-xs text-muted-foreground max-w-md leading-relaxed">
            Selecciona una fase (Engage o Explore) y un tipo de recurso
            didáctico de la lista superior para comenzar a experimentar con la
