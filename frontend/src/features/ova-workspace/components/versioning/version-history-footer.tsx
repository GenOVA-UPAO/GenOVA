...
function compareStatus(count: number): string {
  if (count === 2) return "2 versiones marcadas para comparar.";
...
export function VersionHistoryFooter({ canCompare, selectedCount, comparing, onCompare, onClose }: Readonly<Props>) {
  return (
