...
export const RESOURCE_CONFIG_SCHEMA: Record<string, ConfigField[]> = {
  ...
  "engage:2": [
    N("duration_seconds", "Segundos video", 20, 60, 40, "Duración del video de apertura"),
  ],
  ...
  "engage:6": [
    N("body_words", "Palabras cuerpo", 60, 130, 90, "Extensión del cuerpo de la noticia ficticia"),
  ],
  "engage:7": [
    N(
      "context_words",
  ...
  // explore
  "explore:1": [
    N("num_iterations", "Iteraciones", 2, 5, 3, "Iteraciones requeridas para completar el lab"),
  ],
  ...
  "explore:4": [
    V("num_pauses", "Pausas activas", 1, 5, 3, "Preguntas de pausa activa en el video"),
  ],
  "explore:5": [N("num_records", "Registros", 6, 15, 8, "Registros en el dataset de exploración")],
  "explore:6": [
    N("num_zones", "Zonas/estados", 2, 4, 3, "Zonas de comportamiento en el simulador paramétrico"),
  ],
  ...
  "explore:10": [
    N("num_trials", "Pruebas", 2, 5, 3, "Pruebas antes de revelar la solución óptima"),
  ],
  // explain
  "explain:1": [
    V("num_markers", "Marcadores", 2, 5, 4, "Marcadores temporales en el video teórico"),
  ],
  ...
  // elaborate
  "elaborate:1": [
    N("num_questions", "Preguntas", 3, 6, 4, "Preguntas progresivas del caso de estudio"),
  ],
  "elaborate:2": [N("num_steps", "Pasos", 3, 7, 5, "Pasos del ejercicio guiado de aplicación")],
  "elaborate:3": [
    N("num_deliverables", "Entregables", 2, 5, 3, "Entregables evaluables del mini-proyecto"),
  ],
  "elaborate:4": [N("num_params", "Parámetros", 2, 5, 3, "Parámetros ajustables de la simulación")],
  "elaborate:5": [
    N("num_questions", "Preguntas", 2, 5, 3, "Preguntas de exploración en el dashboard"),
  ],
  "elaborate:6": [
    N("num_decisions", "Decisiones", 2, 4, 3, "Niveles de decisión en el escenario ramificado"),
  ],
  "elaborate:7": [
    N("num_exercises", "Ejercicios", 2, 5, 3, "Ejercicios de pseudocódigo en el lab"),
  ],
  ...
  "evaluate:2": [
    N("num_criteria", "Criterios", 3, 6, 5, "Criterios de la rúbrica de autoevaluación"),
  ],
  "evaluate:3": [
  ...
  "evaluate:4": [
    N("num_questions", "Preguntas", 5, 12, 8, "Preguntas del examen de opción múltiple"),
  ],
  ...
  "evaluate:9": [
    N("num_decisions", "Decisiones", 2, 5, 3, "Decisiones evaluables en la simulación"),
  ],
  "evaluate:10": [
    N("num_competencias", "Competencias", 2, 5, 3, "Competencias adquiridas en el diploma"),
  ],
};
