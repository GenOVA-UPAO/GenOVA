...
export function RoleFormModal({
  editingRole, roleName, roleDescription, selectedPermissions,
  formError, isSubmitting,
  onRoleNameChange, onRoleDescriptionChange, onPermissionToggle,
  onSubmit, onClose,
}) {
  return (
              ...
              {AVAILABLE_PERMISSIONS.map((perm) => (
                ...
                >
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs text-muted-foreground mt-0.5">{perm.desc}</span>
                  </div>
                </label>
              ))}
            </div>
