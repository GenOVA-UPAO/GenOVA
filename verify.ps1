...
if (Test-Path "graphify-out/graph.json") {
    ...
    # CI commits graphify-out/ automatically after each push (graphify-sync.yml).
    # Local auto-commits caused rebase conflicts; use scripts/graphify-commit.ps1 manually.
}
