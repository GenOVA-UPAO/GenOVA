...
import { EditUserModal } from '@/features/admin/components/users/EditUserModal'
import { UsersTable } from '@/features/admin/components/users/UsersTable'
import { useUsersAdmin } from '@/features/admin/hooks/useUsersAdmin'
import type { AdminUser } from '../lib/types'

function buildWhatsAppHref(payload: unknown): string | null {
  if (!payload || typeof payload !== 'object') return null
  const obj = payload as Record<string, unknown>
  const url = obj.whatsapp_url
...
export function AdminUsersPage() {
  ...
  async function runWhatsAppReset(userId: string) {
  ...
  const handlers = {
    ...
    handleSendResetEmail,
    runWhatsAppReset,
    openEdit: (user: AdminUser) => setEditingUser(user),
  }
