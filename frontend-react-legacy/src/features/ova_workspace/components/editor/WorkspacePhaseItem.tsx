...
import { PhaseVersionHistory } from '@/features/ova_workspace/components/versioning/PhaseVersionHistory'
import type { PhaseWithContent } from '@/features/ova_workspace/lib/types'

interface WorkspacePhaseItemProps {
...
export function WorkspacePhaseItem({
  ...
  onDelete,
  onReverted,
}: WorkspacePhaseItemProps) {
  const [historyOpen, setHistoryOpen] = useState(false)
  const [mode, setMode] = useState<'edit' | 'regen' | null>(null)
