...
import { usePhaseGeneration } from '@/features/ova_workspace/hooks/usePhaseGeneration'
...
interface PhasePageProps {
  ...
  emoji: string
  description: string
  fetchRecursos: () => Promise<{ recursos?: Resource[] }>
  generateResource: (resourceId: string, concept: string) => Promise<unknown>
}
      ...
      <div className="rounded-xl border border-border bg-card p-5 shadow-sm space-y-4">
        ...
        {selectedResource && (
          <p className="text-xs text-muted-foreground">
            ...
            <span className="font-medium text-primary">
              {selectedResource.emoji} {selectedResource.tipo}
            </span>
          </p>
        )}
        ...
        {loading && (
          <div className="flex items-center gap-3 text-sm text-muted-foreground">
            ...
            <span>
              Llamando a Groq + OpenRouter... esto puede tomar 20–60 segundos.
            </span>
          </div>
        )}
