...
_STATUS_BY_ERROR: dict[type[UserError], int] = {
    ...
    EnabledModelsNotSaved: status.HTTP_500_INTERNAL_SERVER_ERROR,
    SettingsWriteFailed: status.HTTP_500_INTERNAL_SERVER_ERROR,
    PlatformConfigNotSaved: status.HTTP_500_INTERNAL_SERVER_ERROR,
    NodesConfigNotSaved: status.HTTP_500_INTERNAL_SERVER_ERROR,
}
