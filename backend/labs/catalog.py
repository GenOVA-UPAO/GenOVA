...
AVAILABLE_MODELS = [
    ...
    {"id": "meta-llama/llama-3.3-70b-instruct:free","provider": "openrouter", "label": "Llama 3.3 70B OR (free)"},
    {"id": "deepseek/deepseek-r1:free",             "provider": "openrouter", "label": "DeepSeek R1 (free)"},
]

_FORBIDDEN_CDN = [
    "jsdelivr", "cdnjs", "unpkg.com", "jquery.min.js",
    "bootstrap.min", "googleapis.com/ajax", "maxcdn",
]
